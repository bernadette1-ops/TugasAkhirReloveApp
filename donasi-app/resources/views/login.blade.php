            ...
            <div class="absolute left-[75px] top-1/2 -translate-y-1/2 w-[520px] h-[260px] z-10">
                ...
                <div class="flex flex-col justify-center h-full">
                    ...
                    <p class="text-[20px] leading-[1.8] text-[#14213d]/90">
                        ...
                        Platform donasi pakaian untuk membantu sesama
                        dengan lebih mudah, nyaman, dan bermanfaat bagi
                        banyak orang.
                ...
                <div class="h-full flex flex-col">
                    ...
                    <div class="h-[90px] flex flex-col justify-end">
                        ...
                        <div class="text-center text-sm text-gray-500">
                            ...
                            <a href="/register" class="text-[#7f9cf5] hover:text-[#667eea] font-medium">
